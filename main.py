    ...
    if 'play' in command:
       ...
       pywhatkit.search(ob)
        ...
        exit(run_alexa)
         ...
         subprocess.call("C:/Program Files/JetBrains/PyCharm Community Edition 2021.2.1/bin/pycharm64.exe"); run_alexa()
        ...
        ob = command.replace('search youtube for' ,'')
        querrt = ("https://www.youtube.com/results?search_query=" +ob)
        talk("Searching For"+ob)
        open(querrt)
